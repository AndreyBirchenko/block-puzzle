...
namespace GamingMonks
{
    public class AdmobManager : Singleton<AdmobManager>
    {
...
#elif UNITY_ANDROID
            string adUnitId = "ca-app-pub-8801497656721723/4985016255";
#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-8801497656721723/4985016255";
#else
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
            string adUnitId = "ca-app-pub-7598525447393130/3280005502";
#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-7598525447393130/3280005502";
#else
        string adUnitId = "unexpected_platform";
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
            string adUnitId = "ca-app-pub-7598525447393130/4095792524";
#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-7598525447393130/4095792524";
#else
        string adUnitId = "unexpected_platform";
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
            string adUnitId = "ca-app-pub-8801497656721723/6049283549";
#elif UNITY_IPHONE
            string adUnitId = "ca-app-pub-8801497656721723/6049283549";
#else
            string adUnitId = "unexpected_platform";
